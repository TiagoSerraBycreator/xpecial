...
export default function CandidateConfigPage() {
  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Gerencie suas configurações de conta e segurança</p>
      </div>
        ...
        <TabsContent value="account" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Controle o status da sua conta e suas configurações de atividade
              </CardDescription>
            </CardHeader>
            <CardContent>
              <AccountActivity 
